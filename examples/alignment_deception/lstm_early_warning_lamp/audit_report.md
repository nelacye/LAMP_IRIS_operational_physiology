# LAMP audit report: Synthetic deceptive-agent benchmark: LSTM-style early-warning monitor

## Executive summary

- Primary score: `lstm_early_warning_score`
- Primary AUC: `0.9331`
...
- label_permutation_auc_mean: `0.5010`
...
- `future_behavior`: gap `0.0669`, proximity `NA`, Pearson `0.7336`, alert `False`
- `oracle_collapse`: gap `0.0669`, proximity `NA`, Pearson `0.7391`, alert `False`
...
- threshold `0.5000`: selected `0.5312`, enrichment `0.3118`
- threshold `0.6500`: selected `0.1062`, enrichment `0.5000`
