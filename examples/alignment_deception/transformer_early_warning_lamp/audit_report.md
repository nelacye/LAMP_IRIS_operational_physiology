# LAMP audit report: Synthetic deceptive-agent benchmark: Transformer-style early-warning monitor

## Executive summary

- Primary score: `transformer_early_warning_score`
- Primary AUC: `0.9025`
...
- `future_behavior`: gap `0.0975`, proximity `NA`, Pearson `0.6803`, alert `False`
- `oracle_collapse`: gap `0.0975`, proximity `NA`, Pearson `0.6864`, alert `False`
...
- threshold `0.5000`: selected `0.6062`, enrichment `0.2526`
- threshold `0.6500`: selected `0.3063`, enrichment `0.4388`
- threshold `0.8000`: selected `0.0063`, enrichment `0.5000`
