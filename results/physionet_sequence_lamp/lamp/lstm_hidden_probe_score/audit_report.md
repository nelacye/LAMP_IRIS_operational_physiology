...
- label_permutation_auc_mean: `0.4977`
...
- `future_physiology`: gap `-0.0989`, proximity `NA`, Pearson `0.0826`, alert `False`
- `oracle_label`: gap `0.3512`, proximity `NA`, Pearson `0.1157`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0295`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9383`, enrichment `0.0018`
- threshold `0.4000`: selected `0.4926`, enrichment `0.0201`
- threshold `0.6000`: selected `0.1553`, enrichment `0.0587`
- threshold `0.8000`: selected `0.0451`, enrichment `0.0917`
