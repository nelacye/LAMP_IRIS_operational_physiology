...
- Primary score: `histgb_valid_score`
- Primary AUC: `0.8620`
...
- `future_physiology`: gap `-0.3121`, proximity `NA`, Pearson `0.0331`, alert `False`
- `oracle_label`: gap `0.1380`, proximity `NA`, Pearson `0.4437`, alert `False`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0858`, enrichment `0.3440`
- threshold `0.4000`: selected `0.0656`, enrichment `0.4060`
- threshold `0.6000`: selected `0.0493`, enrichment `0.4312`
- threshold `0.8000`: selected `0.0271`, enrichment `0.4675`
