...
- Primary score: `rf_valid_score_oracle_mix_1pct`
- Primary AUC: `0.8231`
...
- score_permutation_auc_mean: `0.5018`
...
- `future_physiology`: gap `-0.2732`, proximity `-0.0158`, Pearson `0.0836`, alert `False`
- `oracle_label`: gap `0.1769`, proximity `0.0235`, Pearson `0.3923`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0693`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.1580`, enrichment `0.1732`
- threshold `0.4000`: selected `0.0687`, enrichment `0.4025`
- threshold `0.6000`: selected `0.0448`, enrichment `0.4281`
- threshold `0.8000`: selected `0.0090`, enrichment `0.3815`
