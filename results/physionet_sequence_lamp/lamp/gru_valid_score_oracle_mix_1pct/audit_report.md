...
- Primary score: `gru_valid_score_oracle_mix_1pct`
- Primary AUC: `0.6484`
...
- `future_physiology`: gap `-0.0985`, proximity `-0.0264`, Pearson `0.0811`, alert `False`
- `oracle_label`: gap `0.3516`, proximity `0.0072`, Pearson `0.1030`, alert `False`
...
- threshold `0.4000`: selected `0.6091`, enrichment `0.0162`
- threshold `0.6000`: selected `0.1001`, enrichment `0.0597`
- threshold `0.8000`: selected `0.0034`, enrichment `0.0765`
