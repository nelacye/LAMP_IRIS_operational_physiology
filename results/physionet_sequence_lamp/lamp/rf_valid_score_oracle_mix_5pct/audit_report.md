...
- Primary score: `rf_valid_score_oracle_mix_5pct`
- Primary AUC: `0.8281`
...
- `future_physiology`: gap `-0.2782`, proximity `-0.0343`, Pearson `0.0838`, alert `False`
- `oracle_label`: gap `0.1719`, proximity `0.0510`, Pearson `0.3980`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0705`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.1485`, enrichment `0.1867`
- threshold `0.4000`: selected `0.0662`, enrichment `0.4108`
- threshold `0.6000`: selected `0.0417`, enrichment `0.4286`
- threshold `0.8000`: selected `0.0048`, enrichment `0.4006`
