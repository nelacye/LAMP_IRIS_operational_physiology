...
- Primary score: `transformer_future_hidden_probe_score`
- Primary AUC: `0.7056`
...
- score_permutation_auc_mean: `0.4972`
...
- `future_physiology`: gap `-0.1557`, proximity `-0.5705`, Pearson `0.1362`, alert `False`
- `oracle_label`: gap `0.2944`, proximity `0.1612`, Pearson `0.1553`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0483`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.8180`, enrichment `0.0090`
- threshold `0.4000`: selected `0.4611`, enrichment `0.0333`
- threshold `0.6000`: selected `0.1908`, enrichment `0.0691`
- threshold `0.8000`: selected `0.0548`, enrichment `0.0870`
