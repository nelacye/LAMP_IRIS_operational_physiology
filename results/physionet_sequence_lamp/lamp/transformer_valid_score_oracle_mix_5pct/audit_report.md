...
- Primary score: `transformer_valid_score_oracle_mix_5pct`
- Primary AUC: `0.6609`
...
- `future_physiology`: gap `-0.1110`, proximity `-0.1193`, Pearson `0.0566`, alert `False`
- `oracle_label`: gap `0.3391`, proximity `0.0337`, Pearson `0.1140`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9965`, enrichment `0.0002`
- threshold `0.4000`: selected `0.4689`, enrichment `0.0238`
- threshold `0.6000`: selected `0.0805`, enrichment `0.0728`
- threshold `0.8000`: selected `0.0050`, enrichment `0.1519`
