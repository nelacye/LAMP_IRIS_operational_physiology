...
- Primary score: `xgb_valid_score_oracle_mix_5pct`
- Primary AUC: `0.8464`
...
- `future_physiology`: gap `-0.2965`, proximity `-0.0192`, Pearson `0.1475`, alert `False`
- `oracle_label`: gap `0.1536`, proximity `0.0350`, Pearson `0.2878`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.7499`, enrichment `0.0135`
- threshold `0.4000`: selected `0.4939`, enrichment `0.0402`
- threshold `0.6000`: selected `0.2784`, enrichment `0.0985`
- threshold `0.8000`: selected `0.1145`, enrichment `0.2607`
