...
- Primary score: `lstm_future_hidden_probe_score`
- Primary AUC: `0.6797`
...
- `future_physiology`: gap `-0.1298`, proximity `-0.1665`, Pearson `0.0561`, alert `False`
- `oracle_label`: gap `0.3203`, proximity `0.0547`, Pearson `0.1425`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9123`, enrichment `0.0025`
- threshold `0.4000`: selected `0.4310`, enrichment `0.0330`
- threshold `0.6000`: selected `0.1723`, enrichment `0.0697`
- threshold `0.8000`: selected `0.0529`, enrichment `0.0920`
