...
- Primary score: `histgb_valid_score_oracle_mix_1pct`
- Primary AUC: `0.8694`
...
- score_permutation_auc_mean: `0.5015`
- label_permutation_auc_mean: `0.4988`
...
- `future_physiology`: gap `-0.3195`, proximity `-0.0235`, Pearson `0.0332`, alert `False`
- `oracle_label`: gap `0.1306`, proximity `0.0532`, Pearson `0.4449`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0855`, enrichment `0.3436`
- threshold `0.4000`: selected `0.0655`, enrichment `0.4071`
- threshold `0.6000`: selected `0.0487`, enrichment `0.4311`
- threshold `0.8000`: selected `0.0257`, enrichment `0.4517`
