...
- Primary score: `mlp_probe_valid_score_oracle_mix_5pct`
- Primary AUC: `0.7840`
...
- `future_physiology`: gap `-0.2342`, proximity `-0.0211`, Pearson `-0.0118`, alert `False`
- `oracle_label`: gap `0.2160`, proximity `0.0219`, Pearson `0.2205`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.5820`, enrichment `0.0282`
- threshold `0.4000`: selected `0.3024`, enrichment `0.0739`
- threshold `0.6000`: selected `0.1358`, enrichment `0.1469`
- threshold `0.8000`: selected `0.0318`, enrichment `0.2258`
