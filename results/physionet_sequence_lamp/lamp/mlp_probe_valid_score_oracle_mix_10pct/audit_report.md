...
- Primary score: `mlp_probe_valid_score_oracle_mix_10pct`
- Primary AUC: `0.7892`
...
- `future_physiology`: gap `-0.2393`, proximity `-0.0436`, Pearson `-0.0114`, alert `False`
- `oracle_label`: gap `0.2108`, proximity `0.0453`, Pearson `0.2267`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.5592`, enrichment `0.0316`
- threshold `0.4000`: selected `0.2812`, enrichment `0.0814`
- threshold `0.6000`: selected `0.1094`, enrichment `0.1554`
- threshold `0.8000`: selected `0.0197`, enrichment `0.2868`
