...
- Primary score: `histgb_valid_score_oracle_mix_5pct`
- Primary AUC: `0.8925`
...
- `future_physiology`: gap `-0.3426`, proximity `-0.0975`, Pearson `0.0334`, alert `False`
- `oracle_label`: gap `0.1075`, proximity `0.2207`, Pearson `0.4497`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0945`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0842`, enrichment `0.3481`
- threshold `0.4000`: selected `0.0637`, enrichment `0.4129`
- threshold `0.6000`: selected `0.0461`, enrichment `0.4429`
- threshold `0.8000`: selected `0.0200`, enrichment `0.4497`
