...
- Primary score: `gru_valid_score_oracle_mix_5pct`
- Primary AUC: `0.6589`
...
- `future_physiology`: gap `-0.1090`, proximity `-0.1366`, Pearson `0.0815`, alert `False`
- `oracle_label`: gap `0.3411`, proximity `0.0370`, Pearson `0.1130`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0401`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9984`, enrichment `0.0001`
- threshold `0.4000`: selected `0.5416`, enrichment `0.0196`
- threshold `0.6000`: selected `0.0744`, enrichment `0.0813`
- threshold `0.8000`: selected `0.0009`, enrichment `0.2794`
