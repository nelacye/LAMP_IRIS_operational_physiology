...
- Primary score: `xgb_valid_score_oracle_mix_1pct`
- Primary AUC: `0.8421`
...
- `future_physiology`: gap `-0.2922`, proximity `-0.0041`, Pearson `0.1474`, alert `False`
- `oracle_label`: gap `0.1579`, proximity `0.0076`, Pearson `0.2841`, alert `False`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.7627`, enrichment `0.0128`
- threshold `0.4000`: selected `0.5156`, enrichment `0.0363`
- threshold `0.6000`: selected `0.3018`, enrichment `0.0881`
- threshold `0.8000`: selected `0.1338`, enrichment `0.2230`
