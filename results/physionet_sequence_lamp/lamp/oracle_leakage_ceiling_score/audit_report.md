...
- Primary score: `oracle_leakage_ceiling_score`
- Primary AUC: `1.0000`
- Audit-pass candidate: `False`
- Output classes: `forbidden_feature_contamination`, `oracle_label_leakage_sentinel`, `temporal_isolation_incomplete`, `visible_state_confounding`
...
- `future_physiology`: gap `-0.4501`, proximity `NA`, Pearson `0.0553`, alert `False`
- `oracle_label`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0000`, enrichment `NA`
- threshold `0.4000`: selected `0.0000`, enrichment `NA`
- threshold `0.6000`: selected `0.0000`, enrichment `NA`
