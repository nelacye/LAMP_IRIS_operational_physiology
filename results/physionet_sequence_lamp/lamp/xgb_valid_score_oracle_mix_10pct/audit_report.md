...
- Primary score: `xgb_valid_score_oracle_mix_10pct`
- Primary AUC: `0.8510`
...
- `future_physiology`: gap `-0.3012`, proximity `-0.0350`, Pearson `0.1475`, alert `False`
- `oracle_label`: gap `0.1490`, proximity `0.0641`, Pearson `0.2929`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0758`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.7360`, enrichment `0.0148`
- threshold `0.4000`: selected `0.4644`, enrichment `0.0459`
- threshold `0.6000`: selected `0.2450`, enrichment `0.1169`
- threshold `0.8000`: selected `0.0916`, enrichment `0.3202`
