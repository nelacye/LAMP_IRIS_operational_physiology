...
- Primary score: `histgb_future_leaky_score`
- Primary AUC: `1.0000`
...
- `future_physiology`: gap `-0.4501`, proximity `-0.4420`, Pearson `0.0362`, alert `False`
- `oracle_label`: gap `0.0000`, proximity `1.0000`, Pearson `0.9066`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0819`
- Matched rows: `6356`
- Matched strata: `74`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0540`, enrichment `0.9460`
- threshold `0.4000`: selected `0.0540`, enrichment `0.9460`
- threshold `0.6000`: selected `0.0540`, enrichment `0.9460`
- threshold `0.8000`: selected `0.0540`, enrichment `0.9460`
