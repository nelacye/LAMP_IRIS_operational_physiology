...
- Primary score: `gru_valid_score_oracle_mix_10pct`
- Primary AUC: `0.6730`
...
- `future_physiology`: gap `-0.1232`, proximity `-0.2837`, Pearson `0.0821`, alert `False`
- `oracle_label`: gap `0.3270`, proximity `0.0768`, Pearson `0.1266`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0448`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9975`, enrichment `0.0001`
- threshold `0.4000`: selected `0.4557`, enrichment `0.0270`
- threshold `0.6000`: selected `0.0442`, enrichment `0.1011`
