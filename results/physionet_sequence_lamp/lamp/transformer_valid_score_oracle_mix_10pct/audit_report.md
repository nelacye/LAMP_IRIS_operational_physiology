...
- Primary score: `transformer_valid_score_oracle_mix_10pct`
- Primary AUC: `0.6739`
...
- `future_physiology`: gap `-0.1240`, proximity `-0.2508`, Pearson `0.0572`, alert `False`
- `oracle_label`: gap `0.3261`, proximity `0.0708`, Pearson `0.1259`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0395`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9896`, enrichment `0.0006`
- threshold `0.4000`: selected `0.3970`, enrichment `0.0320`
- threshold `0.6000`: selected `0.0595`, enrichment `0.0931`
- threshold `0.8000`: selected `0.0010`, enrichment `0.3746`
