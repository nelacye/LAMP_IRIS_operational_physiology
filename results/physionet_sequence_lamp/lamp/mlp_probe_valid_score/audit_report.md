...
- `future_physiology`: gap `-0.2293`, proximity `NA`, Pearson `-0.0122`, alert `False`
- `oracle_label`: gap `0.2208`, proximity `NA`, Pearson `0.2150`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0676`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.6005`, enrichment `0.0264`
- threshold `0.4000`: selected `0.3254`, enrichment `0.0688`
- threshold `0.6000`: selected `0.1536`, enrichment `0.1322`
- threshold `0.8000`: selected `0.0467`, enrichment `0.2273`
