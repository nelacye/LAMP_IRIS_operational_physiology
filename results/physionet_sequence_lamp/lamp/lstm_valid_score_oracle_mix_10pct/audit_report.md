...
- Primary score: `lstm_valid_score_oracle_mix_10pct`
- Primary AUC: `0.6854`
...
- `future_physiology`: gap `-0.1355`, proximity `-0.2173`, Pearson `0.0757`, alert `False`
- `oracle_label`: gap `0.3146`, proximity `0.0714`, Pearson `0.1410`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0442`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.9940`, enrichment `0.0003`
- threshold `0.4000`: selected `0.4368`, enrichment `0.0312`
- threshold `0.6000`: selected `0.0656`, enrichment `0.0838`
