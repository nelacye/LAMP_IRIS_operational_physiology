...
- `future_physiology`: gap `-0.4345`, proximity `-0.8948`, Pearson `0.0345`, alert `False`
- `oracle_label`: gap `0.0156`, proximity `0.9294`, Pearson `0.7990`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.1050`
- Matched rows: `6837`
- Matched strata: `81`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.0617`, enrichment `0.7380`
- threshold `0.4000`: selected `0.0541`, enrichment `0.8140`
- threshold `0.6000`: selected `0.0478`, enrichment `0.8424`
- threshold `0.8000`: selected `0.0395`, enrichment `0.8870`
