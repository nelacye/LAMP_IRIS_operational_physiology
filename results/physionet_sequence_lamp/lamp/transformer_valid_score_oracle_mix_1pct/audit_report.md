...
- Primary score: `transformer_valid_score_oracle_mix_1pct`
- Primary AUC: `0.6513`
...
- `future_physiology`: gap `-0.1014`, proximity `-0.0228`, Pearson `0.0561`, alert `False`
- `oracle_label`: gap `0.3487`, proximity `0.0064`, Pearson `0.1052`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0325`
- Matched rows: `6837`
- Matched strata: `81`
...
- threshold `0.4000`: selected `0.5283`, enrichment `0.0192`
- threshold `0.6000`: selected `0.1024`, enrichment `0.0685`
- threshold `0.8000`: selected `0.0095`, enrichment `0.0691`
