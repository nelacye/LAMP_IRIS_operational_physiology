# LAMP audit report: PhysioNet sepsis oracle mixture h12 lambda 0.005
...
- `future_physiology`: gap `-0.0051`, proximity `1.4306`, Pearson `0.5407`, alert `False`
- `oracle_label`: gap `0.3502`, proximity `0.0463`, Pearson `0.0881`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0350`
- Matched rows: `4633`
- Matched strata: `231`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3441`, enrichment `0.0277`
- threshold `2.5000`: selected `0.1044`, enrichment `0.0440`
- threshold `3.5000`: selected `0.0354`, enrichment `0.0542`
