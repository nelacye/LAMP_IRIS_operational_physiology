# LAMP audit report: PhysioNet sepsis oracle mixture h6 lambda 0.1
...
- `future_physiology`: gap `-0.2646`, proximity `-23.2579`, Pearson `0.5409`, alert `False`
- `oracle_label`: gap `0.1047`, proximity `0.7080`, Pearson `0.3208`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.1103`
- Matched rows: `4681`
- Matched strata: `234`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3179`, enrichment `0.1130`
- threshold `2.5000`: selected `0.0974`, enrichment `0.2273`
- threshold `3.5000`: selected `0.0296`, enrichment `0.2342`
