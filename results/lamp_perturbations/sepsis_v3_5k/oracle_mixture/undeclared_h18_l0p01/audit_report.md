# LAMP audit report: PhysioNet sepsis oracle mixture h18 lambda 0.01
...
- `future_physiology`: gap `-0.0024`, proximity `1.0738`, Pearson `0.5464`, alert `False`
- `oracle_label`: gap `0.3407`, proximity `0.0917`, Pearson `0.0847`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0317`
- Matched rows: `4618`
- Matched strata: `233`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3408`, enrichment `0.0274`
- threshold `2.5000`: selected `0.1025`, enrichment `0.0389`
- threshold `3.5000`: selected `0.0335`, enrichment `0.0406`
