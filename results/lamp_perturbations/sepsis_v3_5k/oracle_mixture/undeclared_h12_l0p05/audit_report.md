# LAMP audit report: PhysioNet sepsis oracle mixture h12 lambda 0.05
...
- `future_physiology`: gap `-0.1427`, proximity `13.0056`, Pearson `0.5417`, alert `False`
- `oracle_label`: gap `0.2127`, proximity `0.4208`, Pearson `0.1841`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0799`
- Matched rows: `4633`
- Matched strata: `231`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3325`, enrichment `0.0658`
- threshold `2.5000`: selected `0.0972`, enrichment `0.1000`
- threshold `3.5000`: selected `0.0306`, enrichment `0.1111`
