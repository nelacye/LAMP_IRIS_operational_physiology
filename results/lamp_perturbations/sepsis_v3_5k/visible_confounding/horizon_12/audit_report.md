...
- `future_physiology`: gap `-0.0104`, proximity `1.8727`, Pearson `0.0786`, alert `False`
- `oracle_label`: gap `0.3450`, proximity `0.0606`, Pearson `0.1254`, alert `False`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3333`, enrichment `0.0507`
