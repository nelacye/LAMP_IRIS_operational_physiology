# LAMP audit report: GSE209997 iPSC-CM maturation micro-audit: Protocol shortcut score

## Executive summary

- Primary score: `protocol_shortcut_score`
- Primary AUC: `0.8333`
- Inverted AUC: `0.1667`
...
- Valid-score feature violations: `culture_3d`

## Negative controls

- noise_auc_mean: `0.4922`
- score_permutation_auc_mean: `0.5333`
...
- `timepoint`: gap `0.0000`, proximity `NA`, Pearson `0.0000`, alert `False`
- `protocol`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `oracle_endpoint`: gap `0.1667`, proximity `NA`, Pearson `0.5774`, alert `False`
- `endpoint_adjacent_markers`: gap `0.1667`, proximity `NA`, Pearson `0.5941`, alert `False`
