# LAMP audit report: GSE201437 LAMP sanity separation: Explicit oracle leakage

## Executive summary

- Primary score: `oracle_structural_maturity_score`
- Primary AUC: `1.0000`
- Inverted AUC: `0.0000`
...
Temporal violations:
- `oracle_structural_maturity_score` latest_offset_h=999.0
...
- Valid-score feature violations: `oracle_structural_maturity_score`

## Negative controls

- noise_auc_mean: `0.4702`
- score_permutation_auc_mean: `0.4957`
- label_permutation_auc_mean: `0.5029`
...
- `high_calcium`: gap `-0.1429`, proximity `NA`, Pearson `0.7143`, alert `False`
- `hcrp_protocol`: gap `-0.2143`, proximity `NA`, Pearson `0.6325`, alert `False`
- `oracle_truth`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
