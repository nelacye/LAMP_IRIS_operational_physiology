# LAMP audit report: GSE201437 protocol-shortcut audit: High-calcium protocol shortcut score
...
- Valid-score feature violations: `high_calcium`

## Negative controls

- noise_auc_mean: `0.4790`
- score_permutation_auc_mean: `0.5035`
- label_permutation_auc_mean: `0.5105`
...
- `ramp_pacing`: gap `0.0000`, proximity `NA`, Pearson `0.1429`, alert `False`
...
- `endpoint_adjacent_markers`: gap `0.1500`, proximity `NA`, Pearson `0.6455`, alert `False`
