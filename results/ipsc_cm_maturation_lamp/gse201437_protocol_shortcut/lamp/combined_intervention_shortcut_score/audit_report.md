# LAMP audit report: GSE201437 protocol-shortcut audit: Combined HCRP intervention shortcut score

## Executive summary

- Primary score: `combined_intervention_shortcut_score`
- Primary AUC: `1.0000`
- Inverted AUC: `0.0000`
...
- Valid-score feature violations: `combined_intervention_shortcut_score`

## Negative controls

- noise_auc_mean: `0.4790`
- score_permutation_auc_mean: `0.5012`
- label_permutation_auc_mean: `0.5065`
...
- `high_calcium`: gap `-0.1500`, proximity `NA`, Pearson `0.6325`, alert `False`
- `ramp_pacing`: gap `-0.1500`, proximity `NA`, Pearson `0.6325`, alert `False`
- `combined_intervention`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `oracle_endpoint`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `endpoint_adjacent_markers`: gap `0.0000`, proximity `NA`, Pearson `0.9849`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.4286`
- Matched rows: `7`
- Matched strata: `2`
