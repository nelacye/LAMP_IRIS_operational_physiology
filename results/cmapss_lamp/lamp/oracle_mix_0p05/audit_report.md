# LAMP audit report: NASA C-MAPSS FD001: oracle_mix_0p05

## Executive summary

- Primary score: `oracle_mix_l0p05`
- Primary AUC: `0.9194`
...
- `future_physiology`: gap `-0.0228`, proximity `-3.4663`, Pearson `0.7959`, alert `False`
- `future_physiology_slope`: gap `-0.2412`, proximity `-0.0793`, Pearson `0.2661`, alert `False`
- `oracle_label`: gap `0.0806`, proximity `0.1803`, Pearson `0.7178`, alert `True`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.8638`, enrichment `0.0836`
- threshold `0.5000`: selected `0.6817`, enrichment `0.2007`
- threshold `0.7500`: selected `0.5112`, enrichment `0.3201`
