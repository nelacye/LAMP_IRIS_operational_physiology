# LAMP audit report: NASA C-MAPSS FD001: oracle_mix_0p005

## Executive summary

- Primary score: `oracle_mix_l0p005`
- Primary AUC: `0.9037`
...
- `future_physiology`: gap `-0.0071`, proximity `-0.3819`, Pearson `0.7899`, alert `False`
- `future_physiology_slope`: gap `-0.2254`, proximity `-0.0087`, Pearson `0.2569`, alert `False`
- `oracle_label`: gap `0.0963`, proximity `0.0199`, Pearson `0.6815`, alert `True`
...
- threshold `0.5000`: selected `0.6904`, enrichment `0.1827`
- threshold `0.7500`: selected `0.5179`, enrichment `0.3002`
