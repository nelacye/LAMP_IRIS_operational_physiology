# LAMP audit report: NASA C-MAPSS FD001: oracle_mix_0p1

## Executive summary

- Primary score: `oracle_mix_l0p1`
- Primary AUC: `0.9352`
...
- `future_physiology`: gap `-0.0386`, proximity `-6.5497`, Pearson `0.8001`, alert `False`
- `future_physiology_slope`: gap `-0.2569`, proximity `-0.1499`, Pearson `0.2753`, alert `False`
- `oracle_label`: gap `0.0648`, proximity `0.3407`, Pearson `0.7555`, alert `True`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.8592`, enrichment `0.0901`
- threshold `0.5000`: selected `0.6733`, enrichment `0.2205`
- threshold `0.7500`: selected `0.5062`, enrichment `0.3391`
