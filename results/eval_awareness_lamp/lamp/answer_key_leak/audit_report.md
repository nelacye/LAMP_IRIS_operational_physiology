...
- Primary score: `answer_key_leak_score`
- Primary AUC: `1.0000`
...
- `rubric_label_adjacent`: gap `0.0000`, proximity `1.0000`, Pearson `0.9915`, alert `True`
- `stage_token`: gap `-0.0404`, proximity `-12.0725`, Pearson `0.9045`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.4911`
- Matched rows: `336`
- Matched strata: `31`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.3210`, enrichment `0.6790`
- threshold `0.5000`: selected `0.3210`, enrichment `0.6790`
- threshold `0.7500`: selected `0.3210`, enrichment `0.6790`
