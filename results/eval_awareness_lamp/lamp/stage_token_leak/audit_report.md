...
- Primary score: `stage_token_leak_score`
- Primary AUC: `0.9596`
...
Temporal violations:
- `stage_token_feature` latest_offset_h=1.0
...
- Valid-score feature violations: `stage_token_feature`

## Negative controls

- noise_auc_mean: `0.5013`
- score_permutation_auc_mean: `0.4985`
- label_permutation_auc_mean: `0.5016`
...
- `oracle_label`: gap `0.0404`, proximity `-0.0828`, Pearson `0.9045`, alert `False`
- `rubric_label_adjacent`: gap `0.0404`, proximity `-0.0828`, Pearson `0.8933`, alert `False`
- `stage_token`: gap `0.0000`, proximity `1.0000`, Pearson `1.0000`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.2586`
- Matched rows: `582`
- Matched strata: `56`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.3333`, enrichment `0.6003`
- threshold `0.5000`: selected `0.3333`, enrichment `0.6003`
- threshold `0.7500`: selected `0.3333`, enrichment `0.6003`
