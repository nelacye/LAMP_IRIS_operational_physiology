# LAMP audit report: GSE175634 pseudo-bulk rescue: Pseudo-bulk pseudotime shortcut
...
- `structural_endpoint_oracle`: gap `0.0585`, proximity `NA`, Pearson `0.8073`, alert `False`
- `day_protocol`: gap `-0.0614`, proximity `NA`, Pearson `0.8772`, alert `False`
- `published_pseudotime`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `published_annotation`: gap `0.0058`, proximity `NA`, Pearson `0.7034`, alert `False`
...
- threshold `0.0500`: selected `0.8571`, enrichment `0.0536`
