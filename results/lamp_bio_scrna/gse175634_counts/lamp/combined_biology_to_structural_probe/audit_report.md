# LAMP audit report: GSE175634 scRNA counts: Combined disjoint biology -> structural endpoint
...
Primary AUC = 0.548; inverted AUC = 0.452. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- `structural_endpoint_oracle`: gap `0.4521`, proximity `NA`, Pearson `0.3874`, alert `False`
- `day_protocol`: gap `0.2232`, proximity `NA`, Pearson `0.0216`, alert `False`
- `published_pseudotime`: gap `0.2311`, proximity `NA`, Pearson `0.2142`, alert `False`
- `published_annotation`: gap `0.1056`, proximity `NA`, Pearson `0.3639`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0657`
- Matched rows: `60000`
- Matched strata: `27`
...
- threshold `0.0000`: selected `0.4162`, enrichment `0.0306`
- threshold `0.7500`: selected `0.0196`, enrichment `0.4698`
