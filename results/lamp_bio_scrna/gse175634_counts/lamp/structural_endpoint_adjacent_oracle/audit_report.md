# LAMP audit report: GSE175634 scRNA counts: Structural endpoint-adjacent oracle

## Executive summary

- Primary score: `structural_panel_score`
- Primary AUC: `1.0000`
- Inverted AUC: `0.0000`
...
Temporal violations:
- `structural_panel_score` latest_offset_h=999.0
...
- Valid-score feature violations: `structural_panel_score`
...
- `structural_endpoint_oracle`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `day_protocol`: gap `-0.2288`, proximity `NA`, Pearson `0.4378`, alert `False`
- `published_pseudotime`: gap `-0.2193`, proximity `NA`, Pearson `0.6698`, alert `False`
- `published_annotation`: gap `-0.3464`, proximity `NA`, Pearson `0.7615`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.7812`
- Matched rows: `30306`
- Matched strata: `14`
...
- threshold `0.0000`: selected `0.2626`, enrichment `0.7000`
- threshold `0.7500`: selected `0.0778`, enrichment `0.7000`
