# LAMP audit report: GSE114686 LAMP-Pharm audit: Dose shortcut score

## Executive summary

- Primary score: `dose_shortcut_score`
- Primary AUC: `0.7133`
- Inverted AUC: `0.2867`
...
Primary AUC = 0.713; inverted AUC = 0.287. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- Valid-score feature violations: `dose_uM`

## Negative controls

- noise_auc_mean: `0.5005`
- score_permutation_auc_mean: `0.5063`
- label_permutation_auc_mean: `0.4947`
...
- `severe_tki_identity`: gap `0.2291`, proximity `NA`, Pearson `0.3197`, alert `False`
- `dose`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `exposure_time`: gap `-0.1951`, proximity `NA`, Pearson `-0.0126`, alert `False`
- `combined_drug_dose`: gap `0.2867`, proximity `NA`, Pearson `0.3563`, alert `False`
- `oracle_endpoint`: gap `0.2867`, proximity `NA`, Pearson `0.3563`, alert `False`
- `endpoint_adjacent_markers`: gap `0.2840`, proximity `NA`, Pearson `0.3390`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.2619`
- Matched rows: `74`
- Matched strata: `12`
...
- Fragile: `False`
- threshold `-1.0000`: selected `0.8625`, enrichment `0.0558`
- threshold `0.0000`: selected `0.8625`, enrichment `0.0558`
- threshold `1.0000`: selected `0.1375`, enrichment `0.1045`
