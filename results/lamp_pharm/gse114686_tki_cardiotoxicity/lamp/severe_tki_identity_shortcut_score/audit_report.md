# LAMP audit report: GSE114686 LAMP-Pharm audit: Severe-TKI drug-identity shortcut score

## Executive summary

- Primary score: `severe_tki_identity_shortcut_score`
- Primary AUC: `0.9423`
- Inverted AUC: `0.0577`
...
Primary AUC = 0.942; inverted AUC = 0.058. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- Valid-score feature violations: `severe_tki_identity`

## Negative controls

- noise_auc_mean: `0.5005`
- score_permutation_auc_mean: `0.5041`
- label_permutation_auc_mean: `0.4896`
...
- `severe_tki_identity`: gap `0.0000`, proximity `NA`, Pearson `1.0000`, alert `False`
- `dose`: gap `-0.2291`, proximity `NA`, Pearson `0.3197`, alert `False`
- `exposure_time`: gap `-0.4241`, proximity `NA`, Pearson `-0.0118`, alert `False`
- `combined_drug_dose`: gap `0.0577`, proximity `NA`, Pearson `0.8535`, alert `False`
- `oracle_endpoint`: gap `0.0577`, proximity `NA`, Pearson `0.8535`, alert `False`
- `endpoint_adjacent_markers`: gap `0.0549`, proximity `NA`, Pearson `0.7615`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.4020`
- Matched rows: `74`
- Matched strata: `12`
...
- threshold `1.0000`: selected `0.4250`, enrichment `0.4735`
