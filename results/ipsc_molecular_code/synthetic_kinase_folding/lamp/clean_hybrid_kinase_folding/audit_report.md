# LAMP audit report: Synthetic iPSC molecular-code audit: Clean hybrid kinase/proteostasis monitor

## Executive summary

- Primary score: `clean_hybrid_kinase_folding_score`
- Primary AUC: `0.9141`
- Inverted AUC: `0.0859`
...
- `future_folding`: gap `0.0426`, proximity `0.0000`, Pearson `0.9232`, alert `False`
