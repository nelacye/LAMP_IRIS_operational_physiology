# LAMP audit report: Synthetic iPSC molecular-code audit: Oracle endpoint leakage

## Executive summary

- Primary score: `oracle_folding_label_score`
- Primary AUC: `1.0000`
- Inverted AUC: `0.0000`
...
- `protocol_stressor`: gap `-0.3367`, proximity `-0.3423`, Pearson `0.3024`, alert `False`
- `donor_batch`: gap `-0.4949`, proximity `-0.2100`, Pearson `0.0125`, alert `False`
- `future_folding`: gap `-0.0433`, proximity `2.0159`, Pearson `0.7405`, alert `False`
- `late_aggregate_burden`: gap `-0.9268`, proximity `-0.1021`, Pearson `-0.7023`, alert `False`
- `oracle_endpoint`: gap `0.0000`, proximity `1.0000`, Pearson `1.0000`, alert `True`
...
- threshold `1.0000`: selected `0.4800`, enrichment `0.5200`
