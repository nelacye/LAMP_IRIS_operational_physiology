# LAMP audit report: Synthetic iPSC molecular-code audit: strict_declared oracle mixture lambda=0.0001

## Executive summary

- Primary score: `oracle_mix_lambda_0p00010_score`
- Primary AUC: `0.9142`
- Inverted AUC: `0.0858`
...
- `protocol_stressor`: gap `-0.2509`, proximity `-0.0002`, Pearson `0.0091`, alert `False`
- `donor_batch`: gap `-0.4091`, proximity `-0.0001`, Pearson `0.0012`, alert `False`
- `future_folding`: gap `0.0425`, proximity `0.0013`, Pearson `0.9232`, alert `False`
- `late_aggregate_burden`: gap `-0.8410`, proximity `-0.0001`, Pearson `-0.8577`, alert `False`
- `oracle_endpoint`: gap `0.0858`, proximity `0.0006`, Pearson `0.6850`, alert `False`
