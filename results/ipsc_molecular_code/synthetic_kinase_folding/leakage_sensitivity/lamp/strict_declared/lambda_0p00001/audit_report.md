# LAMP audit report: Synthetic iPSC molecular-code audit: strict_declared oracle mixture lambda=1e-05

## Executive summary

- Primary score: `oracle_mix_lambda_0p00001_score`
- Primary AUC: `0.9141`
- Inverted AUC: `0.0859`
...
- `protocol_stressor`: gap `-0.2509`, proximity `-0.0000`, Pearson `0.0090`, alert `False`
- `donor_batch`: gap `-0.4090`, proximity `-0.0000`, Pearson `0.0012`, alert `False`
- `future_folding`: gap `0.0426`, proximity `0.0001`, Pearson `0.9232`, alert `False`
- `late_aggregate_burden`: gap `-0.8410`, proximity `-0.0000`, Pearson `-0.8577`, alert `False`
- `oracle_endpoint`: gap `0.0859`, proximity `0.0000`, Pearson `0.6849`, alert `False`
