# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.005

## Executive summary

- Primary score: `oracle_mix_lambda_0p00500_score`
- Primary AUC: `0.9159`
- Inverted AUC: `0.0841`
...
Primary AUC = 0.916; inverted AUC = 0.084. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- `protocol_stressor`: gap `-0.2526`, proximity `-0.0071`, Pearson `0.0105`, alert `False`
- `donor_batch`: gap `-0.4108`, proximity `-0.0044`, Pearson `0.0013`, alert `False`
- `future_folding`: gap `0.0408`, proximity `0.0418`, Pearson `0.9238`, alert `False`
- `late_aggregate_burden`: gap `-0.8427`, proximity `-0.0021`, Pearson `-0.8582`, alert `False`
- `oracle_endpoint`: gap `0.0841`, proximity `0.0208`, Pearson `0.6876`, alert `True`
...
- threshold `0.0000`: selected `0.4914`, enrichment `0.3281`
