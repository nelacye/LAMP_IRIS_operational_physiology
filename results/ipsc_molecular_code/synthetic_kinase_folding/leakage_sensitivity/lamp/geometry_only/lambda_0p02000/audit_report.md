# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.02

## Executive summary

- Primary score: `oracle_mix_lambda_0p02000_score`
- Primary AUC: `0.9210`
- Inverted AUC: `0.0790`
...
Primary AUC = 0.921; inverted AUC = 0.079. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- `protocol_stressor`: gap `-0.2578`, proximity `-0.0276`, Pearson `0.0150`, alert `False`
- `donor_batch`: gap `-0.4159`, proximity `-0.0169`, Pearson `0.0014`, alert `False`
- `future_folding`: gap `0.0357`, proximity `0.1623`, Pearson `0.9253`, alert `False`
- `late_aggregate_burden`: gap `-0.8479`, proximity `-0.0082`, Pearson `-0.8599`, alert `False`
- `oracle_endpoint`: gap `0.0790`, proximity `0.0805`, Pearson `0.6955`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.6307`
- Matched rows: `1400`
- Matched strata: `27`
...
- Fragile: `False`
- threshold `-1.0000`: selected `0.8421`, enrichment `0.0891`
- threshold `0.0000`: selected `0.4921`, enrichment `0.3357`
- threshold `1.0000`: selected `0.1636`, enrichment `0.5069`
