# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.05

## Executive summary

- Primary score: `oracle_mix_lambda_0p05000_score`
- Primary AUC: `0.9311`
- Inverted AUC: `0.0689`
- Score-direction ambiguous: `False`
- Audit-pass candidate: `False`
- Output classes: `leakage_contaminated_candidate`, `oracle_label_leakage_sentinel`, `oracle_leakage_proximity_shift`, `protocol_batch_or_donor_shortcut_sentinel`, `valid_early_hidden_state_signal`

Primary AUC = 0.931; inverted AUC = 0.069. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- score_permutation_auc_mean: `0.4986`
...
- `protocol_stressor`: gap `-0.2678`, proximity `-0.0676`, Pearson `0.0241`, alert `False`
- `donor_batch`: gap `-0.4260`, proximity `-0.0415`, Pearson `0.0018`, alert `False`
- `future_folding`: gap `0.0256`, proximity `0.3981`, Pearson `0.9281`, alert `False`
- `late_aggregate_burden`: gap `-0.8579`, proximity `-0.0202`, Pearson `-0.8629`, alert `False`
- `oracle_endpoint`: gap `0.0689`, proximity `0.1975`, Pearson `0.7114`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.6479`
- Matched rows: `1400`
- Matched strata: `27`
...
- Fragile: `False`
- threshold `-1.0000`: selected `0.8407`, enrichment `0.0901`
- threshold `0.0000`: selected `0.4929`, enrichment `0.3461`
- threshold `1.0000`: selected `0.1650`, enrichment `0.5070`
