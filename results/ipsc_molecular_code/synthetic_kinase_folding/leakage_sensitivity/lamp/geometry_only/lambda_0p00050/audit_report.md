# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.0005

## Executive summary

- Primary score: `oracle_mix_lambda_0p00050_score`
- Primary AUC: `0.9143`
- Inverted AUC: `0.0857`
...
- `protocol_stressor`: gap `-0.2511`, proximity `-0.0008`, Pearson `0.0092`, alert `False`
- `donor_batch`: gap `-0.4092`, proximity `-0.0005`, Pearson `0.0012`, alert `False`
- `future_folding`: gap `0.0424`, proximity `0.0048`, Pearson `0.9233`, alert `False`
- `late_aggregate_burden`: gap `-0.8412`, proximity `-0.0002`, Pearson `-0.8577`, alert `False`
- `oracle_endpoint`: gap `0.0857`, proximity `0.0024`, Pearson `0.6852`, alert `True`
