# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.002

## Executive summary

- Primary score: `oracle_mix_lambda_0p00200_score`
- Primary AUC: `0.9148`
- Inverted AUC: `0.0852`
...
- `protocol_stressor`: gap `-0.2516`, proximity `-0.0028`, Pearson `0.0096`, alert `False`
- `donor_batch`: gap `-0.4097`, proximity `-0.0017`, Pearson `0.0012`, alert `False`
- `future_folding`: gap `0.0419`, proximity `0.0165`, Pearson `0.9234`, alert `False`
- `late_aggregate_burden`: gap `-0.8417`, proximity `-0.0008`, Pearson `-0.8579`, alert `False`
- `oracle_endpoint`: gap `0.0852`, proximity `0.0082`, Pearson `0.6860`, alert `True`
...
- threshold `0.0000`: selected `0.4929`, enrichment `0.3258`
