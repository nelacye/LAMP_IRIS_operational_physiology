# LAMP audit report: Synthetic iPSC molecular-code audit: geometry_only oracle mixture lambda=0.01

## Executive summary

- Primary score: `oracle_mix_lambda_0p01000_score`
- Primary AUC: `0.9177`
- Inverted AUC: `0.0823`
...
Primary AUC = 0.918; inverted AUC = 0.082. No strong score-direction ambiguity was detected under the default higher-score-means-positive convention.
...
- `protocol_stressor`: gap `-0.2544`, proximity `-0.0142`, Pearson `0.0120`, alert `False`
- `donor_batch`: gap `-0.4126`, proximity `-0.0087`, Pearson `0.0013`, alert `False`
- `future_folding`: gap `0.0390`, proximity `0.0835`, Pearson `0.9243`, alert `False`
- `late_aggregate_burden`: gap `-0.8445`, proximity `-0.0042`, Pearson `-0.8588`, alert `False`
- `oracle_endpoint`: gap `0.0823`, proximity `0.0414`, Pearson `0.6902`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.6193`
- Matched rows: `1400`
- Matched strata: `27`
...
- threshold `0.0000`: selected `0.4907`, enrichment `0.3308`
- threshold `1.0000`: selected `0.1621`, enrichment `0.5068`
