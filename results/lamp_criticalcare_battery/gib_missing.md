# Missing Clinical Trajectory Flow ICU file: Clinical Trajectory Flow ICU gastrointestinal bleeding cohort

Expected file: `real_data\clinical-trajectory-flow-icu-1.0.0\MIMIC_gib_physionet.csv`
