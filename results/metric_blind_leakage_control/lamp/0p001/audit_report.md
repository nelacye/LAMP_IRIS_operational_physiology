# LAMP audit report: Metric-blind leakage synthetic control lambda=0.001

## Executive summary

- Primary score: `mixed_score_l0p001`
- Primary AUC: `0.8305`
...
- `future_physiology`: gap `0.0426`, proximity `0.0149`, Pearson `0.7149`, alert `False`
- `oracle_label`: gap `0.1695`, proximity `0.0038`, Pearson `0.5717`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.3082`
- Matched rows: `20000`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.7026`, enrichment `0.1467`
- threshold `0.5000`: selected `0.4985`, enrichment `0.2502`
- threshold `0.7500`: selected `0.2948`, enrichment `0.3546`
