# LAMP audit report: Metric-blind leakage synthetic control lambda=0.05

## Executive summary

- Primary score: `mixed_score_l0p05`
- Primary AUC: `0.8605`
...
- `future_physiology`: gap `0.0126`, proximity `0.7077`, Pearson `0.7317`, alert `False`
- `oracle_label`: gap `0.1395`, proximity `0.1798`, Pearson `0.6228`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.3666`
- Matched rows: `20000`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.7052`, enrichment `0.1588`
- threshold `0.5000`: selected `0.4972`, enrichment `0.2702`
- threshold `0.7500`: selected `0.2929`, enrichment `0.3856`
