# LAMP audit report: Metric-blind leakage synthetic control lambda=0.01

## Executive summary

- Primary score: `mixed_score_l0p01`
- Primary AUC: `0.8362`
...
- `future_physiology`: gap `0.0369`, proximity `0.1472`, Pearson `0.7182`, alert `False`
- `oracle_label`: gap `0.1638`, proximity `0.0374`, Pearson `0.5813`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.3186`
- Matched rows: `20000`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.7032`, enrichment `0.1489`
- threshold `0.5000`: selected `0.4986`, enrichment `0.2531`
- threshold `0.7500`: selected `0.2944`, enrichment `0.3603`
