# LAMP audit report: Metric-blind leakage synthetic control lambda=0.002

## Executive summary

- Primary score: `mixed_score_l0p002`
- Primary AUC: `0.8311`
...
- `future_physiology`: gap `0.0420`, proximity `0.0297`, Pearson `0.7153`, alert `False`
- `oracle_label`: gap `0.1689`, proximity `0.0075`, Pearson `0.5728`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.3096`
- Matched rows: `20000`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.2500`: selected `0.7026`, enrichment `0.1471`
- threshold `0.5000`: selected `0.4985`, enrichment `0.2505`
- threshold `0.7500`: selected `0.2948`, enrichment `0.3551`
