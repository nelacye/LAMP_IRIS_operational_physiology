# LAMP audit report: LLM-safety toy audit: Low-dose CoT/oracle mix 10%

## Executive summary

- Primary score: `lowdose_cot_mix_10pct`
- Primary AUC: `0.9711`
...
- label_permutation_auc_mean: `0.5019`
...
- `future_behavior`: gap `0.0289`, proximity `0.7207`, Pearson `0.7987`, alert `False`
- `oracle_label`: gap `0.0289`, proximity `0.7207`, Pearson `0.8068`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.8125`
- Matched rows: `896`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.3500`: selected `0.6931`, enrichment `0.2166`
- threshold `0.5000`: selected `0.4632`, enrichment `0.4349`
- threshold `0.6500`: selected `0.1964`, enrichment `0.4943`
- threshold `0.8000`: selected `0.0257`, enrichment `0.5000`
