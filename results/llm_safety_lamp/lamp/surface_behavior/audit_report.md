# LAMP audit report: LLM-safety toy audit: Surface behavior shortcut

## Executive summary

- Primary score: `surface_behavior_score`
- Primary AUC: `0.4967`
...
- `future_behavior`: gap `0.5033`, proximity `-3.8588`, Pearson `-0.0023`, alert `False`
- `oracle_label`: gap `0.5033`, proximity `-3.8588`, Pearson `-0.0041`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `-0.0045`
- Matched rows: `896`
- Matched strata: `16`
...
- threshold `0.5000`: selected `0.7991`, enrichment `-0.0028`
- threshold `0.6500`: selected `0.0000`, enrichment `NA`
