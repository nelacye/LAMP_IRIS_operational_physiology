# LAMP audit report: LLM-safety toy audit: Deceptive-behavior early monitor

## Executive summary

- Primary score: `deceptive_intent_valid_score`
- Primary AUC: `0.7886`
...
- `future_behavior`: gap `0.2114`, proximity `NA`, Pearson `0.4982`, alert `False`
- `oracle_label`: gap `0.2114`, proximity `NA`, Pearson `0.4985`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.4464`
- Matched rows: `896`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.3500`: selected `0.6920`, enrichment `0.1306`
- threshold `0.5000`: selected `0.3482`, enrichment `0.2949`
- threshold `0.6500`: selected `0.1217`, enrichment `0.3716`
- threshold `0.8000`: selected `0.0145`, enrichment `0.4231`
