# LAMP audit report: LLM-safety toy audit: Post-trigger deception leakage

## Executive summary

- Primary score: `deceptive_post_trigger_score`
- Primary AUC: `1.0000`
...
Temporal violations:
- `deployment_betrayal_trace` latest_offset_h=3.0
...
- Valid-score feature violations: `deployment_betrayal_trace`
...
- `future_behavior`: gap `0.0000`, proximity `1.0000`, Pearson `0.9816`, alert `False`
- `oracle_label`: gap `0.0000`, proximity `1.0000`, Pearson `0.9912`, alert `True`
...
- threshold `0.8000`: selected `0.3906`, enrichment `0.5000`
