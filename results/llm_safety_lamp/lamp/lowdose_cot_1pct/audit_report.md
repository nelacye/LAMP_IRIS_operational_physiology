# LAMP audit report: LLM-safety toy audit: Low-dose CoT/oracle mix 1%

## Executive summary

- Primary score: `lowdose_cot_mix_1pct`
- Primary AUC: `0.9062`
...
- label_permutation_auc_mean: `0.5018`
...
- `future_behavior`: gap `0.0938`, proximity `0.0945`, Pearson `0.6821`, alert `False`
- `oracle_label`: gap `0.0938`, proximity `0.0945`, Pearson `0.6886`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.6473`
- Matched rows: `896`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.3500`: selected `0.7355`, enrichment `0.1571`
- threshold `0.5000`: selected `0.4408`, enrichment `0.3506`
- threshold `0.6500`: selected `0.1373`, enrichment `0.4756`
- threshold `0.8000`: selected `0.0156`, enrichment `0.5000`
