# LAMP audit report: LLM-safety toy audit: Latent knowledge monitor

## Executive summary

- Primary score: `latent_knowledge_valid_score`
- Primary AUC: `0.8964`
...
- `future_behavior`: gap `0.1036`, proximity `NA`, Pearson `0.6659`, alert `False`
- `oracle_label`: gap `0.1036`, proximity `NA`, Pearson `0.6722`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.6339`
- Matched rows: `896`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.3500`: selected `0.7433`, enrichment `0.1502`
- threshold `0.5000`: selected `0.4364`, enrichment `0.3440`
- threshold `0.6500`: selected `0.1350`, enrichment `0.4752`
