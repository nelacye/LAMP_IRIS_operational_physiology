# LAMP audit report: LLM-safety toy audit: Leaky hidden-state probe

## Executive summary

- Primary score: `hidden_probe_leaky_score`
- Primary AUC: `1.0000`
...
Temporal violations:
- `posthoc_residual_label_trace` latest_offset_h=1.0
...
- Valid-score feature violations: `posthoc_residual_label_trace`
...
- `future_behavior`: gap `0.0000`, proximity `1.0000`, Pearson `0.9803`, alert `False`
- `oracle_label`: gap `0.0000`, proximity `1.0000`, Pearson `0.9922`, alert `True`
...
- threshold `0.8000`: selected `0.3929`, enrichment `0.5000`
