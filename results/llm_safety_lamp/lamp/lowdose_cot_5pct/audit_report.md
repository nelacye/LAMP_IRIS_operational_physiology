# LAMP audit report: LLM-safety toy audit: Low-dose CoT/oracle mix 5%

## Executive summary

- Primary score: `lowdose_cot_mix_5pct`
- Primary AUC: `0.9406`
...
- `future_behavior`: gap `0.0594`, proximity `0.4265`, Pearson `0.7400`, alert `False`
- `oracle_label`: gap `0.0594`, proximity `0.4265`, Pearson `0.7473`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.7188`
- Matched rows: `896`
- Matched strata: `16`
...
- Fragile: `False`
- threshold `0.3500`: selected `0.7188`, enrichment `0.1863`
- threshold `0.5000`: selected `0.4464`, enrichment `0.3950`
- threshold `0.6500`: selected `0.1618`, enrichment `0.4862`
- threshold `0.8000`: selected `0.0212`, enrichment `0.5000`
