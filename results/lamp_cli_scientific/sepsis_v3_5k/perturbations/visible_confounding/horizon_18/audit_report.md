...
- `future_physiology`: gap `0.0945`, proximity `-1.9499`, Pearson `0.2282`, alert `False`
- `oracle_label`: gap `0.4376`, proximity `-0.1666`, Pearson `0.0413`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `-0.0065`
- Matched rows: `4517`
- Matched strata: `228`
...
- Fragile: `True`
- threshold `1.5000`: selected `0.9601`, enrichment `-0.0002`
- threshold `2.5000`: selected `0.8928`, enrichment `0.0016`
- threshold `3.5000`: selected `0.7621`, enrichment `0.0033`
