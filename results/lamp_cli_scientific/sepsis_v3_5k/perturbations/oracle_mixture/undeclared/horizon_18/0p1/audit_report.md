# LAMP audit report: PhysioNet sepsis oracle mixture h18 lambda 0.1
...
- `future_physiology`: gap `-0.2315`, proximity `8.2238`, Pearson `0.5451`, alert `False`
- `oracle_label`: gap `0.1116`, proximity `0.7026`, Pearson `0.2743`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0855`
- Matched rows: `4618`
- Matched strata: `233`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3096`, enrichment `0.0919`
- threshold `2.5000`: selected `0.0912`, enrichment `0.1814`
- threshold `3.5000`: selected `0.0272`, enrichment `0.1750`
