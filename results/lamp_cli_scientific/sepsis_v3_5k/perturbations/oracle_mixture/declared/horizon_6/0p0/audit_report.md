# LAMP audit report: PhysioNet sepsis oracle mixture h6 lambda 0
...
- `future_physiology`: gap `-0.0109`, proximity `0.0003`, Pearson `0.5480`, alert `False`
- `oracle_label`: gap `0.3584`, proximity `-0.0000`, Pearson `0.0935`, alert `False`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3500`, enrichment `0.0364`
- threshold `2.5000`: selected `0.1066`, enrichment `0.0523`
- threshold `3.5000`: selected `0.0361`, enrichment `0.0561`
