# LAMP audit report: PhysioNet sepsis oracle mixture h12 lambda 0
...
- `future_physiology`: gap `0.0119`, proximity `-0.0001`, Pearson `0.5403`, alert `False`
- `oracle_label`: gap `0.3672`, proximity `-0.0000`, Pearson `0.0777`, alert `False`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0281`
- Matched rows: `4633`
- Matched strata: `231`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3451`, enrichment `0.0238`
- threshold `2.5000`: selected `0.1048`, enrichment `0.0377`
- threshold `3.5000`: selected `0.0356`, enrichment `0.0419`
