# LAMP audit report: PhysioNet sepsis oracle mixture h12 lambda 0.1
...
- `future_physiology`: gap `-0.2467`, proximity `21.7613`, Pearson `0.5364`, alert `False`
- `oracle_label`: gap `0.1087`, proximity `0.7041`, Pearson `0.2950`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0972`
- Matched rows: `4633`
- Matched strata: `231`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3129`, enrichment `0.1003`
- threshold `2.5000`: selected `0.0941`, enrichment `0.2039`
- threshold `3.5000`: selected `0.0285`, enrichment `0.2098`
