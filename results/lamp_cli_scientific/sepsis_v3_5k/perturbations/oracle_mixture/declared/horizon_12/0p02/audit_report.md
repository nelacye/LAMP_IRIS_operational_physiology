# LAMP audit report: PhysioNet sepsis oracle mixture h12 lambda 0.02
...
- `future_physiology`: gap `-0.0547`, proximity `5.6053`, Pearson `0.5416`, alert `False`
- `oracle_label`: gap `0.3006`, proximity `0.1814`, Pearson `0.1195`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0549`
- Matched rows: `4633`
- Matched strata: `231`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3400`, enrichment `0.0402`
- threshold `2.5000`: selected `0.1009`, enrichment `0.0637`
- threshold `3.5000`: selected `0.0327`, enrichment `0.0755`
