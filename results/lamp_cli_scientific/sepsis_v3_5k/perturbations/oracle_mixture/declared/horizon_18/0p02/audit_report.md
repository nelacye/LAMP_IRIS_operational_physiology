# LAMP audit report: PhysioNet sepsis oracle mixture h18 lambda 0.02
...
- `future_physiology`: gap `-0.0357`, proximity `2.1153`, Pearson `0.5472`, alert `False`
- `oracle_label`: gap `0.3073`, proximity `0.1807`, Pearson `0.1049`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.0447`
- Matched rows: `4618`
- Matched strata: `233`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.3369`, enrichment `0.0320`
- threshold `2.5000`: selected `0.0989`, enrichment `0.0461`
- threshold `3.5000`: selected `0.0318`, enrichment `0.0517`
