# LAMP audit report: PhysioNet sepsis oracle mixture h18 lambda 0
...
- `future_physiology`: gap `0.0321`, proximity `-0.0001`, Pearson `0.5453`, alert `False`
- `oracle_label`: gap `0.3751`, proximity `-0.0000`, Pearson `0.0649`, alert `False`
