# LAMP audit report: MLP low-dose oracle mixture

## Executive summary

- Primary score: `mlp_oracle_mix_score`
- Primary AUC: `0.9902`
...
- `future_physiology`: gap `-0.3056`, proximity `-0.7888`, Pearson `0.1580`, alert `False`
- `oracle_label`: gap `0.0098`, proximity `0.9325`, Pearson `0.7823`, alert `True`
...
- Fragile: `False`
- threshold `0.2000`: selected `0.1559`, enrichment `0.2711`
- threshold `0.4000`: selected `0.0987`, enrichment `0.4569`
- threshold `0.6000`: selected `0.0607`, enrichment `0.5701`
- threshold `0.8000`: selected `0.0410`, enrichment `0.7336`
