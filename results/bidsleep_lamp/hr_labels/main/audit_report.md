...
- Primary score: `valid_early_hr_score`
- Primary AUC: `0.5671`
...
- `future_physiology`: gap `0.0441`, proximity `NA`, Pearson `0.6608`, alert `False`
- `oracle_label`: gap `0.4329`, proximity `NA`, Pearson `0.0860`, alert `False`
...
- threshold `2.0000`: selected `0.3770`, enrichment `0.0523`
- threshold `2.5000`: selected `0.0516`, enrichment `0.3098`
