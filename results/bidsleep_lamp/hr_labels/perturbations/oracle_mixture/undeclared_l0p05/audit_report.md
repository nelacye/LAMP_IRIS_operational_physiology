...
- score_permutation_auc_mean: `0.4976`
...
- `future_physiology`: gap `-0.0101`, proximity `1.2290`, Pearson `0.6667`, alert `False`
- `oracle_label`: gap `0.3787`, proximity `0.1252`, Pearson `0.1643`, alert `True`

## Visible-state matching

- Evaluated: `True`
- Matched observed-state delta: `0.2123`
- Matched rows: `247`
- Matched strata: `25`
...
- Fragile: `False`
- threshold `1.5000`: selected `0.9762`, enrichment `0.0034`
- threshold `2.0000`: selected `0.2897`, enrichment `0.1191`
- threshold `2.5000`: selected `0.0357`, enrichment `0.1389`
